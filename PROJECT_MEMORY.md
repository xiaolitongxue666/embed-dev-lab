...
21) Docs entry: doc/README.md; power-and-common-ground.md; probe-rs.md; scripts-reference.md; getting-started.md. Learn: gpio-eight-modes / gpio-protection / gpio-led-source-sink / uart-ttl-rs232-rs485 / swd-vs-usart; gpio-cnf-mode.md. F103 GPIO source/sink ±8 mA (relaxed ±20); PC13–15 ±3 mA; onboard LED is sink (low=on).
