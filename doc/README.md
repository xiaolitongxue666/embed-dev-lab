...
11. [中断向量表与 NVIC](learn/interrupt-vector-table-and-nvic.md) — 向量表作用、NVIC 职责、与 CMSIS/HAL 关系  
12. [MCP 与 Skill](mcp-skills.md) — embedded-debugger MCP、项目 Skill 安装
...
| [learn/cmsis-overview.md](learn/cmsis-overview.md) | CMSIS 分层、CubeMX、手写兼容边界、与 HAL 关系 |
