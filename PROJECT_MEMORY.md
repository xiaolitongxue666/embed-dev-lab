...
3) Dual tracks: f103-manual-reg (bare regs) vs f103-cmsis-hal (CMSIS+HAL Cube-style). Align external behavior unless user scopes one track. SPI/LSM6DS3, I2C1/SH1106, PB12 LED, PB13 KEY, USART DMA+IDLE, ADC1 PA0 are manual-reg only (2026-09); cmsis-hal still blocking TX-only, no SH1106.
...
13) Vector table full F103xB. USART1 IRQn=37; DMA1 CH4/5/6 =14/15/16. SysTick_Handler in systick.c overrides weak Default. Wrong IRQ name → Default_Handler.
