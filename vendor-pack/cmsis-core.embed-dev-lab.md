# CMSIS + HAL 子模块（embed-dev-lab）

本仓库将 ST **CMSIS-Core**、**CMSIS-Device F1** 与 **stm32f1xx-hal-driver** 作为 **git submodule** 纳入 `vendor-pack/`，版本成对固定，供对照官方模板；**不参与** [`f103-manual-reg`](../projects/f103-manual-reg/) 构建链接。
...
| [stm32f1xx-hal-driver](https://github.com/STMicroelectronics/stm32f1xx-hal-driver) | [`stm32f1xx-hal-driver/`](stm32f1xx-hal-driver/) | tag **`v1.1.8`** | [stm32f1xx-hal-driver.embed-dev-lab.md](stm32f1xx-hal-driver.embed-dev-lab.md) |
...
全包参考：[STM32CubeF1](STM32CubeF1/README.md)（可选 fetch）。
