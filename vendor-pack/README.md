...
| [STMicroelectronics/stm32f1xx-hal-driver](https://github.com/STMicroelectronics/stm32f1xx-hal-driver) | F1 **HAL/LL** 独立组件；[`stm32f1xx-hal-driver.embed-dev-lab.md`](stm32f1xx-hal-driver.embed-dev-lab.md) |
...
说明：[cmsis-core.embed-dev-lab.md](cmsis-core.embed-dev-lab.md) · [cmsis-device-f1.embed-dev-lab.md](cmsis-device-f1.embed-dev-lab.md) · [ST F1 软件仓库归纳](../doc/learn/stm32-cmsis-component-repos.md)
