...
7) LSM6DS3 SPI (manual-reg): spi.c/lsm6ds3.c; Mode 3; silk SCL<-PA5 SDA<-PA7 SAO->PA6 CS<-PA4; power 3V3 not VIN; WHO_AM_I=0x69 (TR-C is 0x6A); 104Hz ±2g/250dps; wait ≥20ms after power.
8) Doc paths: hardware/stm32f103-peripherals.md (wiring); reference/lsm6ds3/ (DocID026899 Chinese excerpts; pdf/*.pdf local gitignored); reference/stm32f103/; workflow-write-build-flash.md.
...
18) clangd: setup-clangd.sh syncs root compile_commands.json after build.
19) MCP: install-mcp-skills.sh; Codex has no MCP.
