...
| 工程 | 芯片 | 说明 | 文档 |
|------|------|------|------|
| [`f103-manual-reg/`](f103-manual-reg/) | STM32F103C8T6 | 全手写寄存器；USART DMA+IDLE + ADC1 PA0 + printf/syscalls | [doc/projects/f103-manual-reg.md](../doc/projects/f103-manual-reg.md) |
