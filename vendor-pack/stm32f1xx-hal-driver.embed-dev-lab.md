...
[`projects/f103-cmsis-hal`](../projects/f103-cmsis-hal/) 通过 `./scripts/fetch-f103-cmsis-hal-deps.sh` 从本 submodule **按需裁剪**拷贝至 [`third_party/`](../projects/f103-cmsis-hal/third_party/)（Inc 全拷、Src 仅 16 个 `.c` 链入 `.elf`）；**完整 HAL 仓库在本 submodule**，`third_party/hal/` 不是完整上游。
